...
По образованию инженер, в IT пришёл через предпринимательство. Запускал **[Logiways](https://logiways.ru/)**, сервис для международной логистики. Не нашёл нормальных разработчиков, решил учиться сам. Начал с вёрстки, потом втянулся в React и всё, что с ним связано.
